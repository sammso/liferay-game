...
package com.liferay.lexicon.test.web.internal.portlet;
...
@Component(
	immediate = true,
	property = {
		"com.liferay.portlet.css-class-wrapper=portlet-lexicon-test",
		...
		"javax.portlet.display-name=Lexicon Test",
